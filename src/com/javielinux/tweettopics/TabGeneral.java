...
public class TabGeneral extends Activity implements UserTwitterStatusAsyncTaskResponder {
	...
	private QuickActionWidgetDF mQuicActionIcons;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBtIcons.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				mQuicActionIcons.show(v);
				/*
				QuickActionsIcons dw = new QuickActionsIcons(v, TabGeneral.this);
    ...
    public void prepareQuickActions() {
		mQuicActionIcons = new QuickActionWidgetDF(this, QuickActionWidgetDF.TYPE_GRID, "icons");
		mQuicActionIcons.addButton(R.string.search_avatar_twitter, new QuickActionWidgetDFButtonOnClick() {
		...
		mQuicActionIcons.setOnGetView(new QuickActionWidgetDFGetView() {

			@Override
			public View OnGetView(int position, View view, ViewGroup parent) {

                Entity icon = mQuicActionIcons.getEntities().get(position);
                              
                ImageView img = new ImageView(TabGeneral.this);
                img.setImageDrawable(icon.getDrawable("icon_small"));
		...
		mQuicActionIcons.setOnQuickActionClickListener(new OnQuickActionClickListener() {
            public void onQuickActionClicked(QuickActionWidget widget, int position) {
            	ArrayList<Entity> icons = DataFramework.getInstance().getEntityList("icons");
            	if (position<icons.size()) {
            		selectIcon(icons.get(position).getId());
            	}
            }
        });
    }
