...
public class TweetTopicsConstants {
    ...
    public static final int COLUMN_MY_ACTIVITY = 1;
    public static final int COLUMN_TIMELINE = 2;
    public static final int COLUMN_MENTIONS = 3;
    public static final int COLUMN_DIRECT_MESSAGES = 4;
    public static final int COLUMN_FAVORITES = 5;
    ...
    public static final int COLUMN_SAVED_TWEETS = 12;
    public static final int COLUMN_FOLLOWERS = 13;
    public static final int COLUMN_FOLLOWINGS = 14;
    public static final int COLUMN_TIMELINE_OF_USER = 15;
