...
public class TweetsConversationAdapter extends ArrayAdapter<InfoTweet> {
    ...
    public TweetsConversationAdapter(FragmentActivity activity, LoaderManager loaderManager, ArrayList<InfoTweet> infoTweetArrayList) {
