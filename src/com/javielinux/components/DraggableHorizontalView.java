...
public class DraggableHorizontalView extends ViewGroup implements View.OnTouchListener, View.OnClickListener, View.OnLongClickListener {
    ...
    protected float zoneMoveHorizontalInDrag = 80;
    protected float speedMoveHorizontalInDrag = 15;
    ...
    public void setZoneMoveHorizontalInDrag(int px) {
        zoneMoveHorizontalInDrag = px;
    }

    public void setSpeedMoveHorizontalInDrag(int speed) {
        speedMoveHorizontalInDrag = speed;
    }

    //CONSTRUCTOR AND HELPERS
    public DraggableHorizontalView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setListeners();
        ...
        public void run()
        {
            if (dragged != -1)
            {
            	if (lastX < (zoneMoveHorizontalInDrag/2) && scroll > 0) {
            		scroll -= speedMoveHorizontalInDrag;
                } else if (lastX < zoneMoveHorizontalInDrag && scroll > 0) {
                    scroll -= (speedMoveHorizontalInDrag/2);
                } else if (lastX > getRight() - getLeft() - (zoneMoveHorizontalInDrag/2) && scroll < getMaxScroll()) {
                    scroll += speedMoveHorizontalInDrag;
                } else if (lastX > getRight() - getLeft() - zoneMoveHorizontalInDrag && scroll < getMaxScroll()) {
            		scroll += (speedMoveHorizontalInDrag/2);
                }
            }
