...
public class TweetQuickAdapter extends ArrayAdapter<Entity> {
	
	private Context context;
	
	public TweetQuickAdapter(Context cnt, ArrayList<Entity> statii) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			v = View.inflate(context, R.layout.row_tweetquick, null);
		} else {
			v = convertView;
		}
		...
		TextView text = (TextView)v.findViewById(R.id.quick_text);
