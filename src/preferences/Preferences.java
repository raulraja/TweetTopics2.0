...
public class Preferences extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBoxPreference pulltorefresh = (CheckBoxPreference) findPreference("prf_use_pulltorefresh");
        pulltorefresh.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
			@Override
